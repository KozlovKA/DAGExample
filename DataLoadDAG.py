...
t2 = SparkSubmitOperator(task_id='DataLoad',
                         ...
                         conf={
                             ...
                             'numPartitions': "9",
                             'PartitionColumn': "product_group",
                             'lowerBound': "1",
                             'upperBound': "10",
                             'url': "jdbc:db2://dashdb-txn-sbox-yp-dal09-14.services.dal.bluemix.net:50000/BLUDB:user=" + Variable.get(
                                 'dbUsername') + ";PWD=" + Variable.get('dbPassword') + ";Security=SSL;",
                             'dbtable': "PRT00338.product_record",
