...
t2 = SparkSubmitOperator(task_id='DataLoad',
                         ...
                         conf={
                             ...
                             'spark.myvariables.driver': "com.ibm.db2.jcc.DB2Driver",
                             'spark.myvariables.dbUsername': Variable.get('dbUsername'),
                             'spark.myvariables.dbPassword': Variable.get('dbPassword'),
                             'spark.kubernetes.driverEnv.source': "jdbc",
                             'spark.myvariables.numPartitions': "5",
                             'spark.myvariables.PartitionColumn': "product_group",
                             'spark.myvariables.lowerBound': "5",
