...
t2 = SparkSubmitOperator(task_id='DataLoad',
                         ...
                         conf={
                             ...
                             'spark.kubernetes.driverEnv.numPartitions': "9",
                             'spark.kubernetes.driverEnv.PartitionColumn': "product_group",
                             'spark.kubernetes.driverEnv.lowerBound': "1",
                             'spark.kubernetes.driverEnv.upperBound': "10",
