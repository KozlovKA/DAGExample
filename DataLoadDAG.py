...
t2 = SparkSubmitOperator(task_id='DataLoad',
                         ...
                         conf={
                             ...
                             'spark.driver': "com.ibm.db2.jcc.DB2Driver",
                             'spark.dbUsername': Variable.get('dbUsername'),
                             'spark.dbPassword': Variable.get('dbPassword'),
                             'spark.kubernetes.driverEnv.source': "jdbc",
                             'spark.numPartitions': "9",
                             'spark.PartitionColumn': "product_group",
                             'spark.lowerBound': "1",
                             'spark.upperBound': "10",
                             'spark.url': "jdbc:db2://dashdb-txn-sbox-yp-dal09-14.services.dal.bluemix.net:50000/BLUDB:user=" + Variable.get(
                                 'dbUsername') + ";PWD=" + Variable.get('dbPassword') + ";Security=SSL;",
                             'spark.dbtable': "PRT00338.product_record",
