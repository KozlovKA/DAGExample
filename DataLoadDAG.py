...
t2 = SparkSubmitOperator(task_id='DataLoad',
                         ...
                         conf={
                             ...
                             'fs.cos.sparkobject123.access.key': os.getenv('access.key'),
                             'fs.cos.sparkobject123.endpoint': os.getenv('endpoint'),
                             'fs.cos.sparkobject123.secret.key': os.getenv('secret.key'),
